...
class ChromeShowPageTraceBehavior {
    ...
    private function showTrace() {
         // 系统默认显示信息
         $REQUEST_TIME=I('server.REQUEST_TIME','','htmlspecialchars,trim');
         $SERVER_PROTOCOL=I('server.SERVER_PROTOCOL','','htmlspecialchars,trim');
         $REQUEST_METHOD=I('server.REQUEST_METHOD','','htmlspecialchars,trim');
        ...
        $trace  =   array();
        $base   =   array(
            '请求信息'  =>  date('Y-m-d H:i:s',$REQUEST_TIME.' '.$SERVER_PROTOCOL.' '.$REQUEST_METHOD.' : '.__SELF__, //需要修改
            '运行时间'  =>  $this->showTime(),
